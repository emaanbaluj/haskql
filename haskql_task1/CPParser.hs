...
happyTokenStrings = ["cp","csv","%eof"]

happyActOffsets :: HappyAddr
happyActOffsets = HappyA# "\xff\xff\xff\xff\xff\xff\xff\xff\x01\x00\x00\x00\xfe\xff\xff\xff\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# "\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"#
...
happyCheck = HappyA# "\xff\xff\xff\xff\x02\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x03\x00\x00\x00\xff\xff\xff\xff\xff\xff\xff\xff"#

happyTable :: HappyAddr
happyTable = HappyA# "\x00\x00\x00\x00\x03\x00\x00\x00\xff\xff\xff\xff\x03\x00\x00\x00\x05\x00\x00\x00\x06\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"#
...
happyRuleArr = HappyA# "\x00\x00\x00\x00\x03\x00\x00\x00"#
...
happyReduction_1 (HappyTerminal (PT _ (TokenCSV happy_var_3)))
        (HappyTerminal (PT _ (TokenCSV happy_var_2)))
        _
         =  HappyAbsSyn5
                 (("cp", happy_var_2, happy_var_3)
        )
happyReduction_1 _ _ _  = notHappyAtAll 

happyTerminalToTok term = case term of {
        PT _ TokenCP -> 2#;
        PT _ (TokenCSV happy_dollar_dollar) -> 3#;
        _ -> -1#;
        }
...
parseCP tks = happyRunIdentity happySomeParser where
